...
export interface KeepRulesProjectExtensionProps
 ...
 *
 * see: https://www.jetbrains.com/help/teamcity/clean-up.html#Clean-up+Rules
 */
export class KeepRulesProjectExtension
  extends BaseProjectExtension<KeepRulesProjectExtensionProps> {
  constructor(scope: Project, props: KeepRulesProjectExtensionProps) {
    super(scope, props);
  }
...
declare module "../project.ts" {
  interface Project {
    /**
     * Adds a new KeepRulesProjectExtension to a Project.
     *
     * ```ts
     ...
     * ```
     */
    KeepRules(props: KeepRulesProjectExtensionProps): KeepRulesProjectExtension;
  }
}

Project.prototype.KeepRules = function (
  this: Project,
  props: KeepRulesProjectExtensionProps,
) {
  return new KeepRulesProjectExtension(this, props);
};
