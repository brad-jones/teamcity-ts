...
- :heavy_check_mark:: This means the feature is fully modeled.
- :test_tube:: This means the feature also has a test case that proves it works
  with the latest version of TeamCity.
- :x:: This means the DSL provides zero support for this feature & you would
  have to model this yourself with an escape hatch.
